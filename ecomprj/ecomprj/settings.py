...
SECRET_KEY = 'django-insecure-dgo-ed33ex&v(rq+x+jwb#e&fw9!cj2kt*pom7^#2kzknut28w'
...
INSTALLED_APPS = [
    ...
    #Custom Apps
    'core', # it is good to use for different sections of your web app
    'userauths',
    'customorder',
...
JAZZMIN_SETTINGS = {
    'site_header': "Ataiza's Upholstery",
    'site_brand': "Ataiza's Upholstery",
    # 'site_logo': "assets/imgs/theme/logo.png",
    'copyright': "Ataiza's Upholstery",
}
