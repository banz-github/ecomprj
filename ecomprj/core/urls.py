...
urlpatterns = [
    ...
    path('order_detail_maindash/<int:id>/', order_detail_maindash, name='order_detail_maindash'),


    path("main-dash/custom-orders/", admindash_custom_orders, name="custom-orders-dash"),
    path('main-dash/most-ordered-materials/<str:product_type>/', most_ordered_materials, name='most_ordered_materials'),
    path('main-dash/most-ordered-colors/<str:product_type>/<str:material_name>/', most_ordered_colors, name='most_ordered_colors'),

    path('main-dash/most-ordered-materials-per-month/<str:product_type>/', most_ordered_materials_per_month, name='most_ordered_materials_per_month'),
    # In your urls.py
    path('main-dash/most-ordered-colors-per-month/<str:product_type>/<str:material_name>/', most_ordered_colors_per_month, name='most_ordered_colors_per_month'),
    ...
    path("main-dash/analytics2/", admindash_analytics2, name="analytics-dash2"),
    
    path("main-dash/custom-orders/custom_order_detail_dashboard/<str:co_id>/", custom_order_detail_dashboard, name="custom_order_detail_dashboard"),

    path("main-dash/reports/", report_dash, name="report-dash"),

    path("main-dash/adminlogs/", recent_admin_actions, name="adminlogs"),
