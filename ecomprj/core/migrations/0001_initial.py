    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='500.00', max_digits=99999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Upholstery/Furniture', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default="Ataiza's", max_length=100)),
                ('image', models.ImageField(default='product.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='Hand-made', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='500.00', max_digits=99999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='1000.00', max_digits=99999999)),
                ('specifications', models.TextField(blank=True, default=' w x d x h', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Ataiza', max_length=100)),
                ('image', models.ImageField(default='vendor.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='Providing top-notch upholstery solutions.', null=True)),
                ('address', models.CharField(default='123 Main Street, Philippines.', max_length=100)),
                ('contact', models.CharField(default='+63 ', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='500.00', max_digits=99999999)),
                ('total', models.DecimalField(decimal_places=2, default='500.00', max_digits=99999999)),
